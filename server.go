...
func serverMain(_ context.Context, cmd *cli.Command) error {
	...
	app.GET("/*any", handleProxy)
	app.POST("/*any", handleProxy)
	app.PUT("/*any", handleProxy)
	app.DELETE("/*any", handleProxy)
	app.PATCH("/*any", handleProxy)
	app.HEAD("/*any", handleProxy)
	app.OPTIONS("/*any", handleProxy)
